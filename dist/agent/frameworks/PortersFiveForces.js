...
exports.PortersFiveForces = void 0;
class PortersFiveForces {
    async analyze(company, analysisText) {
    ...
    generateAssessment(force, level, factors) {
    ...
    calculateAttractiveness(forces) {
        const scores = {
            low: 3,
            moderate: 2,
            high: 1
        };
        const totalScore = scores[forces.competitiveRivalry.intensity] +
    ...
    generateRecommendations(forces, company) {
    ...
    formatAsMarkdown(analysis, company) {
...
exports.PortersFiveForces = PortersFiveForces;
//# sourceMappingURL=PortersFiveForces.js.map